...
(function() {
  ...
  class Animation {
    constructor(worldState, robot, robotState) {
      ...
      this.node.style.cssText = "position: relative; line-height: 0.1; margin-left: 350px"
      ...
      this.button.style.cssText = "color: white; background: #28b; border:; border-radius: 2px; padding: 2px 5px; line-height: 1.1; font-family: sans-serif; font-size: 80%; height:50px ; width:80px ; "
    ...
    updateParcels() {
      ...
      for (let {place, address} of this.worldState.parcels) {
        ...
        node.style.cssText = "position: absolute; height: 10px; width: 10px; background-image: url(../asset/coin.gif); background-position: 0 -" + offset + "px";
